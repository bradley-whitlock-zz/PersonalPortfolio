...
class About extends React.Component {
  constructor(){
    ...
    this.state= {details : 'Currently I am a second year Mechatronics Engineering Student at the University of Waterloo.' +
      ' I thrive on innovation and creation. In my spare time I play volleyball, hockey, bike, pretty much' +
      ' anything that involves pushing myself or being active. In the future I hope to become a product designer and make ' +
